...
function StatsCards(props: StatsCardProps) {
  ...
  return <div className="w-full pt-8 gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
    <StatsCard
      ...
      helperText="All Visits From All Of Lifetime"
    ...
    <StatsCard
      ...
      helperText="All Submissions From All Of Lifetime"
    ...
    <StatsCard
      ...
      helperText="The Rate At Which People Submit"
    ...
    <StatsCard
      ...
      helperText="The Rate At Which People Leave"
    ...
    <CardHeader>
      ...
      <CardDescription className="flex items-center justify-between text-muted-foreground text-sm">
        ...
        {form.published && <span className="flex items-center gap-2">
          ...
          <FaWpforms className="text-muted-foreground"/><span>{form.submissions.toLocaleString()}</span>
          </span>
        }
      </CardDescription>
    </CardHeader>
